...
"[project]/.next-internal/server/app/api/dashboard-ozet/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/dashboard-ozet/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const hesaplaTevkifat = (faturaFiyati)=>{
...
async function GET(request) {
    try {
        ...
        const sirketKarlari = oncekiAySeferler.reduce((acc, sefer)=>{
        ...
        // Toplam kar hesapla
        const toplamKar = sirketKarlariDizi.reduce((toplam, sirket)=>toplam + sirket.kar, 0);
        ...
        const aracKarlari = oncekiAySeferler.reduce((acc, sefer)=>{
        ...
        const response = {
            oncekiAy: {
                ...
                toplamKar,
                sirketKarlari: sirketKarlariDizi.slice(0, 5),
                aracKarlari: aracKarlariDizi,
            ...
            uyarilar: {
                ...
                toplamUyariTutari: [
                    ...vadesiYaklasanCekler,
                    ...vadesiGecenCekler
                ].reduce((sum, cek)=>sum + cek.tutar, 0)
            }
        };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__337cd244._.js.map